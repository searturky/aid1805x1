...
function get_listdata(page = 1) {
    ...
    if (page == 1) {
        data = `[
        {"user":"hxd","receiver":"大壮","address":"Avneue Lorem 30#","total":"740","order_id":"ND201807290001","time":"2018-07-28 12:12:35","status":"complete",
        "courses":[
        ...
        {"user":"rj","receiver":"二壮","address":"Avneue Lorem 35#","total":"440","order_id":"ND201807290002","time":"2018-07-23 14:01:33","status":"uncomplete",
        "courses":[
        ...
        data = `[
        {"user":"rj","receiver":"大壮","address":"Avneue Lorem 30#","total":"740","order_id":"ND201807290001","time":"2018-07-28 12:12:35","status":"complete",
        "courses":[
                    {"name":"大和寿司","price":90,"count":2,"total":180,"bz":"多辣椒"},
                    {"name":"神户牛肉","price":100,"count":1,"total":100,"bz":"少辣椒"},
                    {"name":"提拉米苏","price":80,"count":2,"total":160,"bz":"不要辣椒"},
        ...
        {"user":"rj","receiver":"三壮","address":"Avneue Lorem 30#","total":"740","order_id":"ND201807290001","time":"2018-07-28 12:12:35","status":"complete",
        "courses":[
                    {"name":"大和寿司","price":90,"count":2,"total":180,"bz":"多辣椒"},
                    {"name":"神户牛肉","price":100,"count":1,"total":100,"bz":"少辣椒"},
                    {"name":"提拉米苏","price":80,"count":2,"total":160,"bz":"不要辣椒"},
        ...
        {"user":"rj","receiver":"四壮","address":"Avneue Lorem 35#","total":"440","order_id":"ND201807290002","time":"2018-07-23 14:01:33","status":"uncomplete",
        "courses":[
                    {"name":"大和寿司","price":90,"count":2,"total":180,"bz":"多芥末"},
                    {"name":"神户牛肉","price":100,"count":1,"total":100,"bz":"少芥末"},
                    {"name":"提拉米苏","price":80,"count":2,"total":160,"bz":"不要芥末"}
...
function show_detail(e) {
    ...
    data.forEach(item => {
        if (item.order_id === order_id) {
            window.location.href = "./allDetail.html?order_id=" + order_id;
        }
    });
}
